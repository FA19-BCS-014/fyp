                  ...
                  >
                    ...
                    {step.current === 3 && (
                      <>
                        <p className="msg_notify">
                          <FaInfoCircle />{" "}
                          {values.firstName === "" ? "User" : values.firstName},
                          What's your Email?
                        </p>
                        <FormField
                          title="Email"
                    ...
                    {step.current === 1 && (
                      <div className="form-field account-type">
                        ...
                        >
                          <label
                            className={
                              values.accountType === "1" ? "active" : null
                            }
                          >
                            <FaUserGraduate />
                          ...
                          <label
                            className={
                              values.accountType === "2" ? "active" : null
                            }
                          >
                            <FaUserTie />
                    ...
                    {step.current === 5 && (
                      <>
                        {authFailedMsg ? (
                          ...
                          <p className="msg_notify">
                            <FaInfoCircle /> Account Creation Successful. Check
                            your inbox for activation link!
                          </p>
                        ) : (
                          <p className="msg_notify">
                        ...
                        <ul>
                          <li>
                            <FaUserCircle />{" "}
                            {values.firstName ? values.firstName : "No Name"}{" "}
                            {values.lastName}
                          </li>
                          <li>
                            <FaBriefcase />{" "}
